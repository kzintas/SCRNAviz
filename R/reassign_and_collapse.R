...
collapse_tree <- function(original_graph) {
    ...
    ver_list <- igraph::as_data_frame(original_graph, what = "vertices")
...
#' Reassigns Clusters in Seurat Object and Collapses Clustree
#'
#' This module Reassigns Clusters in Seurat Object and Collapses Clustree.
#'
